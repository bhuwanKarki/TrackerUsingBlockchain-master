...
import BuyView from './components/views/SearchPacket/BuyView';
import SellView from './components/AddPacket/SellView';
      ...
      <div>
        <Router>
          <StyleWrapper>
            <NavigationComponent />
            <div>
              <Route path='/SearchPacket' component={withProps(BuyView, web3Props)} />
              <Route exact path='/' component={Welcome}/>
              <Route path='/AddPacket' component={withProps(SellView, web3Props)} />
            </div>
          </StyleWrapper>
        </Router>
      </div>
